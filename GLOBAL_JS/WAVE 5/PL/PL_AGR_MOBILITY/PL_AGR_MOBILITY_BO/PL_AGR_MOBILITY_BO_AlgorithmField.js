//PL_AGR_MOBILITY_BO - Algorithm Code
/*
 ...
 ***************************/
var Tableau = [
    'section3d8e23837356a927df75#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Assignment Outbound Start (model D);PL_Assignment Outbound Start (model C);PL_Assignment Outbound End (model D);PL_Assignment Outbound End (model C)',
    'section10dcf9d19ea31b754493#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Assignment Outbound Start (model C);PL_Assignment Outbound Start (model D);PL_Assignment Outbound Extension;PL_Assignment Inbound Extension',
    'sectiond82a08d812ad8b26219e#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Assignment Outbound Start (model D);PL_Assignment Outbound Start (model C);PL_Assignment Outbound End (model D);PL_Assignment Outbound End (model C);PL_Assignment Inbound End (model C)',
    'section5beeb402ada7f4614bae#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Assignment Outbound Start (model D);PL_Assignment Outbound Start (model C);PL_Assignment Outbound End (model D);PL_Assignment Outbound End (model C);PL_Assignment Inbound End (model C)',
    'section98115ab366bf8797b72b#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Assignment Outbound End (model D);PL_Assignment Outbound End (model C);PL_Assignment Inbound End (model C)',
    'section3b9396edce43ea1746ef#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Assignment Inbound End (model C)',
    'section31970911821df28eeac0#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Assignment Outbound Start (model C);PL_Assignment Outbound End (model C)',
    'sectiona9743f4457a1d2d98bdb#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Assignment Outbound Start (model C);PL_Assignment Outbound End (model C); PL_Assignment Inbound End (model C) ',
    'sectioncc5edbf6ac193f77950c#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate assignment abroad',
    'sectiona931f0a5fa99cf555352#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate assignment abroad',
    'section3e26f79d7d8e2c7f7c53#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Assignment abroad query;PL_Insurance;PL_Other Mobility query;PL_Foreign employee query;PL_Work/Residence Permit prolongation;PL_Initiate assignment to Poland;PL_Assignment to Poland query',
	'sectionbeb8537596a9e2b9b401#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Assignment abroad query;PL_Insurance;PL_Other Mobility query;PL_Foreign employee query;PL_Work/Residence Permit prolongation;PL_Initiate assignment to Poland;PL_Assignment to Poland query',
	'sectiona245af6369368ac11a7f#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Heavy transfer',
    'section224177fc94a2fca5dc86#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Heavy transfer',
    'sectionb72d740152d868e1fabc#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Heavy transfer'
];
