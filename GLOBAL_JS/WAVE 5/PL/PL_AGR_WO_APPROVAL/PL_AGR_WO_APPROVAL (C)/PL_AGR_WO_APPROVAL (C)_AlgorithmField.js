...
***************************/
var Tableau = [
    'section08a4d198c6f2eed1ce7a#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Start Maternity / Parental Leave',
    'section33c8471b830052ee3919#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Start Maternity / Parental Leave',
	'section316bc6b3b60f8ecd2e8e#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Contract extension',
    'sectione4ed15ffc02741919d83#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Employee initiated resignation',
    'sectiona16787a16cb74d08294c#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Employee initiated resignation',
    'sectiona7ba8c88492d7f911c7f#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate Involuntary leave',
    'section452aaa71277cab1f7f0c#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate Involuntary leave',
    'section63c7aebeae2df974ccd7#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Scheduled report',
    'sectiona12d0c64cd008ed3540a#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_My Learning -Technical issues',
    'section710aa9b05087abe48e26#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_New joiner no show',
    'section881d37e02bfd83e71a12#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Delegation letters',
    'section6765d6aeced91da85a77#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Social security - certificate of coverage',
    'sectiona320d0b444f099e307bb#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Social security - certificate of coverage',
    'sectiondc971a3243f86454d003#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Social security - certificate of coverage',
    'sectiond7a01eb75ead26214128#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Passport / Support letters',
    'sectionf5d6f37b78e6418f3ddc#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate assignment abroad',
    'sectionecba7063107d1b63ff74#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate assignment abroad',
    'section051c1f17de152f6a99fb#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate assignment to Poland',
    'sectionf327da257397c2aa5c94#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate assignment to Poland',
    'section80a47513c6a6a30234a9#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate assignment to Poland',
    'section961ce6eddedcbc073d35#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate assignment to Poland',
    'sectionf02269f08a8a648ee076#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Initiate assignment to Poland',
    'sectiond1ac927b1aa60aaa6db0#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Certificate : Registration of stay of EU citizen in Poland;PL_Certificate of employment with salary details;PL_Certificate of employment',
    //'sectiond1ac927b1aa60aaa6db0#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Certificate of employment with salary details',
    //'sectiond1ac927b1aa60aaa6db0#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Certificate of employment',
    'section18eefae4aa9c37926eb0#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Certificate of employment with salary details',
    'sectionff0f4111b852282e4bd1#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Certificate of employment with salary details',
    'section8d3a15c7ff8a30e19532#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Certificate of employment with salary details',
    'section14dc2e4b9637785ce037#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Certificate of employment with salary details',
    'sectioneaf5ddd3784da0573c7d#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|PL_Certificate of employment'
];
