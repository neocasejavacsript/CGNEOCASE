...
window.sectionVisibilityFunc = function(){
	...
	if(subTopic == "2992" && countryISOCode == 'BE'){
        neocase.form.section("section4516c183ff2ba85de343").show();
    }else{
        neocase.form.section("section4516c183ff2ba85de343").hide();
    }
	
	if(subTopic == "2992" && countryISOCode == 'LU'){
        neocase.form.section("section8b048a513bc611635782").show();
    }else{
        neocase.form.section("section8b048a513bc611635782").hide();
    }
	
	if(subTopic == "2998" && countryISOCode == 'LU'){
        neocase.form.section("sectionedfaaa581d4f933f2b0d").show();
    }else{
        neocase.form.section("sectionedfaaa581d4f933f2b0d").hide();
    }
};
