...
var Tableau = [
    //Employee Details
    'section946#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Experienced hire;EC_College hire;EC_Emergency hire;EC_Hire with prior service;EC_Non start;EC_Intern to hire;EC_InterCo./CrossCountry transfer;EC_Change in start date;EC_Non EE activation;EC_Contract to hire;EC_Mass hire;EC_Change in management team;EC_Change in working hours;EC_Cost center change;EC_Work location transfer;EC_Grade / Job change;EC_Fixed term contract extension;EC_Contract change;EC_Promotion/demotion;EC_Pay change;EC_Company change;EC_Probation period update;EC_Other request (HRBP);EC_Resignation;EC_Resignation withdrawn;EC_International permanent transfer;EC_Change in last working day;EC_Retirement;EC_Involuntary leaver;EC_Mass termination;EC_End of fix-term contract;EC_Non employee deactivation;EC_LOA paid;EC_LOA unpaid;EC_Return from LOA',
    //Only for China
    //section427f15229084f1a43748
    //Only for China with start date
    //section40f08ffa22efc26c3d7d
    //effective date 
    'sectionee52cf4693ac8ed8bc74#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Experienced hire;EC_College hire;EC_Emergency hire;EC_Hire with prior service;EC_InterCo./CrossCountry transfer;EC_Change in start date;EC_Non EE activation;EC_Contract to hire;EC_Mass hire;EC_Change in management team;EC_Cost center change;EC_Work location transfer;EC_Grade / Job change;EC_Fixed term contract extension;EC_Contract change;EC_Promotion/demotion;EC_Pay change;EC_Company change;EC_Reorganization (MU);EC_Change in management team (MU);EC_Change in working hours (MU);EC_Cost center change (MU);EC_Work location transfer (MU);EC_Grade / Job change (MU);EC_Fix term contract extension (MU);EC_Contract change (MU);EC_Promotion/demotion (MU);EC_Pay change (MU);EC_Probation period update (MU);EC_Pay change - ARC (MU);EC_Change in operational team (MU);EC_Mass termination;EC_Change in working hours',
    //reason for action
    'section67ad5029b53ea0c020fc#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Cost center change;EC_Work location transfer;EC_Grade / Job change;EC_Fixed term contract extension;EC_Contract change;EC_Promotion/demotion;EC_Pay change;EC_Company change;EC_Reorganization (MU);EC_Change in working hours (MU);EC_Cost center change (MU);EC_Work location transfer (MU);EC_Grade / Job change (MU);EC_Fix term contract extension (MU);EC_Contract change (MU);EC_Promotion/demotion (MU);EC_Pay change (MU);EC_Change in working hours',
    //Hiring details 
    'sectiondb5a670766b5a6bc8758#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Experienced hire;EC_College hire;EC_Hire with prior service;EC_InterCo./CrossCountry transfer;EC_Non EE activation;EC_Contract to hire;EC_Emergency hire',
    //Change in Start Date
    'sectionef25429bd2a73e93f3fc#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Change in start date',
    //Non start details
    'section2ad7291f164debd92fb0#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Non start',
    //Job details --
    'section3afa8cd8f6351397184d#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Grade / Job change;EC_Contract change;EC_Promotion/demotion;EC_Company change',
    //Grade details -- 
    'section7c6febacac770b77a9f5#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Grade / Job change;EC_Contract change;EC_Promotion/demotion;EC_Company change',
    //Contract details --
    'section488d11600072dad8c063#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Contract change;EC_Company change',
    //Client location -- 
    //'section2230db16f4162c31e868#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Work location transfer;EC_Company change',
    //Working Hours Details
   'section7a0413ee5e85bb83d57e#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Contract change;EC_Change in working hours',
    //Pay -- 
    'sectione86d2b5ce968e3134eda#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Contract change;EC_Promotion/demotion;EC_Pay change;EC_Company change',
    //Only for China : Additional Pay
    //'section4b46190382e80df0747b.INTERVENTIONS_EN_COURS$ELEMENT|EC_Cost center change ;EC_Work location transfer;EC_Grade / Job change;EC_Contract change;EC_Promotion/demotion;EC_Company Change',
    //To be visible only for Belgium 
    //'section84e881c7b3478d8d1722#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Contract change;EC_Promotion/demotion;EC_Pay change',
    //Variable Pay Scheme details -- 
    // 'section3f5fe52bb66ddf74f137#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Promotion/demotion;EC_Company change',
    //Management team  --
    'section635820a60b0aa8a35e70#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Change in management team;EC_Cost center change;EC_Contract change;EC_Company change',
    //Organization assignment
    'section87f23cde18690b8733a4#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Cost center change;EC_Contract change;EC_Promotion/demotion;EC_Work location transfer;EC_Company change',
    //Non-employee deactivation details 
    'section454fe97c88e3c8328945#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Non employee deactivation',
    //Resignation Info
    'sectiond55a88d2ddb5a409d2d3#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Resignation',
    //Termination info 
    'sectionee9edc7a4f05e9676345#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Involuntary leaver',
    //Permanent transfer termination details
    'section404e1594c60f50ed66b8#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_International permanent transfer',
    //Last working day 
    'sectione3e0865e54eb4225eb9e#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Change in last working day;EC_Resignation;EC_Involuntary leaver;EC_Retirement;EC_LOA paid',
    //Leave of Absence Details
   'sectiona3cdb487648837581847#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_LOA paid;EC_LOA unpaid',
    //Return from Leave of Absence
    'sectionefb62d31d876204ed838#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Return from LOA',
    //Fixed Term Contract --
    'section231327c53539e61014f9#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_End of fix-term contract;EC_Fixed term contract extension;EC_Contract change;EC_Company change',
    //Probation Update --
    'section05d607f7459763cb1515#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Probation period update;EC_Company change',
    //Mass Upload 
    'sectiond4b31a6ae7cded1c85a8#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Reorganization (MU);EC_Change in management team (MU);EC_Change in working hours (MU);EC_Cost center change (MU);EC_Work location transfer (MU);EC_Grade / Job change (MU);EC_Fix term contract extension (MU);EC_Contract change (MU);EC_Promotion/demotion (MU);EC_Pay change (MU);EC_Probation period update (MU);EC_Pay change - ARC (MU);EC_Change in operational team (MU);EC_Mass hire;EC_Mass termination'
];
