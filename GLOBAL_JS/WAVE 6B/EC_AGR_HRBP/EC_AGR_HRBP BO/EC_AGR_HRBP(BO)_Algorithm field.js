...
var Tableau = [
    ...
    'section29fd584003b28295dfda#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Change in start date',
    //Non start details
    'section2976f87472f7fcdaf377#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Non start',
    //Job details --
    'sectionf20674ca08692dd70521#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Grade / Job change;EC_Contract change;EC_Promotion/demotion;EC_Company change',
    //Grade details --
    'section2532ab27c39e3815d35d#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Grade / Job change;EC_Contract change;EC_Promotion/demotion;EC_Company change',
    //Contract details --
    'section84dbbc3717610d97e8eb#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Contract change;EC_Company change',
    //Work location to be changed to additional pay --
    //'section245234279744398154ba#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Work location transfer;EC_Company change',
    //Client location --
   ...
   'sectionad3d6a81920ce67a1838#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Contract change;EC_Change in working hours',
    ...
    //'sectionc905e00d48b94f75eaba#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Contract change;EC_Promotion/demotion;EC_Pay change',
    //Variable Pay Scheme details --
    // 'section18a545ec1d9cea2a8917#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Promotion/demotion',
    //Management team --
    'sectiond8861cebeb0781314fbf#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Change in management team;EC_Cost center change;EC_Contract change;EC_Company change',
    //Organization assignment 
    'sectionb3d26af2017b12af1900#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Cost center change;EC_Contract change;EC_Promotion/demotion;EC_Work location transfer;EC_Company change',
    //Non-employee deactivation details 
    'sectionc0b72627a2fffa8e3ccc#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Non employee deactivation',
    //Resignation Info
    'sectionca67256f541151de9a89#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Resignation',
    //Termination info 
    'sectionf4e8add0494794594e00#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Involuntary leaver',
    //Permanent transfer termination details
    'sectionb7af1b24236a4901722e#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_International permanent transfer',
    //Last working day 
    'section0198994ef733c13139de#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Change in last working day;EC_Resignation;EC_Involuntary leaver;EC_Retirement;EC_LOA paid',
    //Leave of Absence Details
   'section60c1342d722b732adaa0#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_LOA paid;EC_LOA unpaid',
    //Return from Leave of Absence
    'section8201a383841c5cfe8dbe#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Return from LOA',
    //Fixed Term Contract --
    'sectionbb2b914eda0fd8e17284#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_End of fix-term contract;EC_Fixed term contract extension;EC_Contract change;EC_Company change',
    //Probation Update --
    'section8b3aa1467da3bf8cf670#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Probation period update;EC_Company change',
    //Mass Upload 
    'section7516d67f81568dea4a25#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|EC_Reorganization (MU);EC_Change in management team (MU);EC_Change in working hours (MU);EC_Cost center change (MU);EC_Work location transfer (MU);EC_Grade / Job change (MU);EC_Fix term contract extension (MU);EC_Contract change (MU);EC_Promotion/demotion (MU);EC_Pay change (MU);EC_Probation period update (MU);EC_Pay change - ARC (MU);EC_Change in operational team (MU);EC_Mass Hire;EC_Mass termination'
];
