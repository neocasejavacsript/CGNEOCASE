/* --- EC_AGR_HRBP(M)Technical Fields --- */
/*--------------------------------------------------------------------------
...
window.disableCusFields = function () {
    ...
    // disableField(neocase.form.field("INTERVENTIONS_EN_COURS$VALEUR734"));//Work Location
    ...
    //disableField(neocase.form.field("INTERVENTIONS_EN_COURS$VALEUR735")); //Work Location (new)
...
window.countryWiseSectionVisibility = function(){
    ...
    try{
        ...
        neocase.form.section('section16ea85fd7422419dc0db').hide(); //Only for China : Additional Pay
        ...
        if(countryIsoCode == 'CN' && countrySAPCode == '28'){
            ...
            neocase.form.section('section40f08ffa22efc26c3d7d').show();
            ...
            if(subtopic == '2969' || subtopic == '2970' || subtopic == '2971' || subtopic == '2973' || subtopic == '2974' || subtopic == '2977'){//EC_Cost center change ;EC_Work location transfer;EC_Grade / Job change;EC_Contract change;EC_Promotion/demotion;EC_Company Change // +MOD-003
                neocase.form.section('section16ea85fd7422419dc0db').show(); //Only for China : Additional Pay
            }
            ...
            if(subtopic == '2970'){
                neocase.form.section('section2230db16f4162c31e868').show();
                ...
                neocase.form.section('section2230db16f4162c31e868').hide();
                neocase.form.section('section3f5fe52bb66ddf74f137').hide(); //Variable Pay Scheme details
            }
            neocase.form.section('section84e881c7b3478d8d1722').hide();
        }
        else if(countryIsoCode == 'BE' && countrySAPCode == '12'){
            if(subtopic == '2975' || subtopic == '2973' || subtopic == '2974'){
                neocase.form.section('section84e881c7b3478d8d1722').show();
            }
            else{
                neocase.form.section('section84e881c7b3478d8d1722').hide();
            }
            neocase.form.section('section40f08ffa22efc26c3d7d').hide();
            neocase.form.section('section2230db16f4162c31e868').hide();
            neocase.form.section('section427f15229084f1a43748').hide();
            neocase.form.section('section3f5fe52bb66ddf74f137').hide();
        }
        else if(countryIsoCode == 'CZ' || countryIsoCode == 'HU' || countryIsoCode == 'IE' || countryIsoCode == 'IT' ){
            if(subtopic == '2974'){
                neocase.form.section('section3f5fe52bb66ddf74f137').show();
