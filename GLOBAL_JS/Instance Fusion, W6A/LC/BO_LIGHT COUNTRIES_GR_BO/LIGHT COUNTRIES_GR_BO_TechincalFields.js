 ...
 * Hide Sections
 ***************/
console.log('start, champ date initiallyMandatory :',neocase.form.field('UTILISATEURSBIS$CHAMPU186').isInitiallyMandatory());
console.log(neocase.form.field('UTILISATEURSBIS$CHAMPU186'));
...
/********************************* start Mod-004 ************************************************/
 window.hideAllSection = function() {
    ...
    console.log('hideAllSection, champ date initiallyMandatory :',neocase.form.field('UTILISATEURSBIS$CHAMPU186').isInitiallyMandatory());
    console.log(neocase.form.field('UTILISATEURSBIS$CHAMPU186'));
...
window.manageSections = function() {
    ...
    console.log('manageSections, champ date initiallyMandatory :',neocase.form.field('UTILISATEURSBIS$CHAMPU186').isInitiallyMandatory());
    console.log(neocase.form.field('UTILISATEURSBIS$CHAMPU186'));
...
window.manageMandatoryFields = function() {
	try {
		...
		var topic = neocase.form.field('MOTSCLES').getValue();
		var subtopic = neocase.form.field('ELEMENTS').getValue();
...
window.onloadForm = function() {
    ...
    console.log('onload, champ date initiallyMandatory :',neocase.form.field('UTILISATEURSBIS$CHAMPU186').isInitiallyMandatory());
    console.log(neocase.form.field('UTILISATEURSBIS$CHAMPU186'));

    //reinit fieldInstances
