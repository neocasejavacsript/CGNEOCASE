/**************		MA_LEAVERS_VOLUNTARY - (M) - FO Algorithm Fields	**************
******************************************************************
...
var Tableau = [
	...
	'section378#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Voluntary leave(Confirmed);Départ Volontaire (date définitive);Voluntary leave(Planned);Départ Volontaire (date prévisionnelle);International transfer(Confirmed);Transfert international (date définitive);End of Fixed Term contract(Planned);Fin du contrat à durée déterminée (date prévisionnelle)',
