/**************		MA_LEAVERS_VOLUNTARY - (M) - FO Technical Fields	*************
******************************************************************
...
Date: 21/06/2017
Description: Updated the break of probation & copvalue & hidefield
******************************************************************
******************************************************************
Modified version - MOD-003
Developer Name: Pierre COINTE
Date: 06/07/2017
Description: Custom field list updated
******************************************************************
*******************************************************************/
...
***************/
//Technical section
ThisForm.HideSection("section682");
...
window.defaultProbationStatusCodeDesc = function(){
	...
	//var probationStatusDescValue = "415ÞUnsuccessful";
		...
		$(probationStatusDescField).find('option[value*=415]').prop('selected',true); //default to unsuccessful
...
window.onloadForm = function(){
	...
	copyValue("INTERVENTIONS_EN_COURS$VALEUR132","INTERVENTIONS_EN_COURS$VALEUR198"); // ++ MOD-002
