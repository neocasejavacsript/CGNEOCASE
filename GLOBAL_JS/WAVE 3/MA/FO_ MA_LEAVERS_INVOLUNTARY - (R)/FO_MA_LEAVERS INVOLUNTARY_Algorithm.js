/**************		MA_LEAVERS_INVOLUNTARY - (R) - FO Algorithm Fields	**************
******************************************************************
...
var Tableau = [
	...
	'section553#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);Involuntary leave(Confirmed);Départ Involontaire (date définitive);Involuntary leave(Planned);Départ Involontaire(date prévisionnelle)',
	
	//Display Confirmed leaving date sections
	'section622#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Involuntary leave(Confirmed);Départ Involontaire (date définitive)',
	
	//Display Fixed term contract sections
	'section141#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive)',
	
	//Display Planned leaving date sections
	'section139#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Involuntary leave(Confirmed);Départ Involontaire (date définitive);Involuntary leave(Planned);Départ Involontaire(date prévisionnelle)',
	
	//Display Involuntary leaving date sections
	'section323#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Involuntary leave(Confirmed);Départ Involontaire (date définitive);Involuntary leave(Planned);Départ Involontaire(date prévisionnelle)',
