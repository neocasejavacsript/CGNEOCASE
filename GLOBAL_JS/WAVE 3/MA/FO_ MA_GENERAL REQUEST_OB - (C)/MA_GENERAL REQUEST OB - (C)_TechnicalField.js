/**************		MA_GENERAL REQUEST OB - (C) - FO Technical Fields	*************
******************************************************************
Developer   - 
Date	    - 14/06/2017
Change No   - MOD-001
...
***************/
//Technical section
ThisForm.HideSection("section35");
...
var msg = "function manageSubtopic : ";
	...
	if(field.value !== "0"){
		if(getSubtopic){
			if(field){
				if(getSubtopic == "Benefits Repricing"){
					field.value = "2276";
				}else if(getSubtopic == "Create Non-Employee"){
					field.value = "2280";
				}else if(getSubtopic == "End of secondment") {
					field.value = "2009";
				}else if(getSubtopic == "Finalize Hire") {
					field.value = "2264";
				}else if(getSubtopic == "General Request") {
					field.value = "2131";
				}else if(getSubtopic == "No show employee") {
					field.value = "2013";
				}else if(getSubtopic == "Non-employee deactivation") {
					field.value = "2230";
				}else if(getSubtopic == "Pre-Hire/Pre-Rehire") {
					field.value = "2258";
				}else if(getSubtopic == "Return From Secondment") {
					field.value = "2262";
				}else{
	...
	console.log("field not avaialble");
	} */
};
