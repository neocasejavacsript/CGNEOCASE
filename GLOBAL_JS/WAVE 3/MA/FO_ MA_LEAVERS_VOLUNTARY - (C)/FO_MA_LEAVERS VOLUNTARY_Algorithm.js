/**************		MA_LEAVERS_VOLUNTARY - (R) - FO Algorithm Fields	**************
******************************************************************
...
var Tableau = [
	...
	'section170#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive)',
	
	//Display notification on leaving sections
	'section553#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Retirement(Confirmed);Retraite (date définitive);Retirement(Planned);Retraite (date prévisionnelle);Voluntary leave(Confirmed);Départ Volontaire (date définitive);Voluntary leave(Planned);Départ Volontaire (date prévisionnelle);End of Fixed Term contract(Planned);Fin du contrat à durée déterminée (date prévisionnelle)',
	
	//Display Confirmed leaving date sections
	'section622#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Retirement(Confirmed);Retraite (date définitive);Voluntary leave(Confirmed);Départ Volontaire (date définitive);International transfer(Confirmed);Transfert international (date définitive)',
	
	//Display Resignation info sections
	'section966#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Break of Probation(Confirmed);Rupture de période d\'essai (date définitive);End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Voluntary leave(Confirmed);Départ Volontaire (date définitive);Voluntary leave(Planned);Départ Volontaire (date prévisionnelle);International transfer(Confirmed);Transfert international (date définitive);End of Fixed Term contract(Planned);Fin du contrat à durée déterminée (date prévisionnelle)',
	
	//Display Fixed term contract sections
	'section141#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);End of Fixed Term contract(Planned);Fin du contrat à durée déterminée (date prévisionnelle)',
	
	//Display Planned leaving date sections
	'section139#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|End of Fixed Term Contract(Confirmed);Fin de contrat à durée déterminée (date définitive);Retirement(Confirmed);Retraite (date définitive);Retirement(Planned);Retraite (date prévisionnelle);Voluntary leave(Confirmed);Départ Volontaire (date définitive);Voluntary leave(Planned);Départ Volontaire (date prévisionnelle);End of Fixed Term contract(Planned);Fin du contrat à durée déterminée (date prévisionnelle)',
	
	//Display Retirement(Confirmed)sections
	'section692#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|Retirement(Confirmed);Retraite (date définitive);Retirement(Planned);Retraite (date prévisionnelle)',
	
	//Display International transfer(Confirmed) sections
	'section853#formulaire.INTERVENTIONS_EN_COURS$ELEMENT|International transfer(Confirmed);Transfert international (date définitive)',
