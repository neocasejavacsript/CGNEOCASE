/**************		FR_GENERAL REQUEST HR_OB - (C) - FO - Technical Fields	*************
******************************************************************
Developer   - 
Date	    - 14/06/2017
Change No   - MOD-001
...
***************/
//Technical section
ThisForm.HideSection("section431");
/******************************
...
Neocase.checkForm = function(){
	...
	***************************************/
	...
	if(lang == "fr"){
		msg = "Merci de renseigner les champs obligatoires suivants :";
	}else{
	...
	if(validator.length > 0){
		for(v=0; v<validator.length; v++){
			...
			if(validatorVisibility == "visible"){
				if(validator[v].id.search("question") != -1){ //++ MOD-002
                    if(lang == "fr"){
                        msg += "\n- Demande initiale ";
                    }else{
                        msg += "\n- Initial question"; //-- MOD-002
                    }
				}else{
