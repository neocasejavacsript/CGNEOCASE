...
Description - updated the subtopic in all front office form 
			- Make the question in read only
...
var msg = "function manageSubtopic : ";
	...
	if(field.value != "0"){
		if(getSubtopic){
			if(field){
				if(getSubtopic == "Salary/GCM update"){
					field.value = "2232";
				}else if(getSubtopic == "Organization"){
					field.value = "2233";
				}else if(getSubtopic == "Management Team") {
					field.value = "2234";
				}else if(getSubtopic == "Exceptional One Time Payment (InterCED tool)") {
					field.value = "2235";
				}else if(getSubtopic == "Mass Hire Action") {
					field.value = "2236";
				}else if(getSubtopic == "Other") {
					field.value = "2140";
				}else{
