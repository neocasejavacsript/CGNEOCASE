...
Change No   - MOD-001
Description - Hide the sections based on Topic,Code cleanUp
------------------------------------------------------------------------------------------------------------------------------------*/
/*-----------------------------------------------------------------------------------------------------------------------------------
Developer   - Suman Saha
Date	    - 05/14/2018 (MM/DD/YYYY)
Change No   - MOD-002
Description - Update the Tablue section,Code cleanUp
------------------------------------------------------------*/
/*----------------------------------------------------------------------------------------------------------------------------------
Developer   - Riya Dutta
Date	    - 05/17/2018 (MM/DD/YYYY)
Change No   - MOD-003
Description - display Section:Salary details,for "FR_Career Change" & "FR_Contract"
------------------------------------------------------------------------------------------------------------------------------------
...
Date	    - 10/11/2018 (MM/DD/YYYY)
Change No   - MOD-005
Description - display Section:"Task Follow up"
------------------------------------------------------------------------------------------------------------------------------------
Developer   - Riya Dutta
 ...
 ***************************/
 var Tableau = [
    ...
    'section580141112fd963c0b1af#formulaire.INTERVENTIONS_EN_COURS$MOTCLE|FR_Leaver;Sortie des effectifs',
    //'section8a946d74df34143b2a03#formulaire.INTERVENTIONS_EN_COURS$MOTCLE|FR_Other changes;Autre changement',
    /* ------------- Start of MOD-006 changes ------*/
    //'section9a1794e27097fcff8ddd#formulaire.INTERVENTIONS_EN_COURS$MOTCLE|FR_Individual bonus;Prime individuelle',
    /* ------------- End of MOD-006 changes -------*/
    //'sectiond5a3eb35040ae6c72772#formulaire.INTERVENTIONS_EN_COURS$MOTCLE|FR_Other changes;Autre changement;FR_Career Change;Données carrière;FR_Organization;Données organisationnelles;FR_Legal entity;Entité légale;FR_Probation period;Période d\'essai;FR_Contract;Contrat;FR_Hiring confirmation;Confirmation d\'embauche;FR_Work from home;Télétravail;FR_Start Date Change;Décalage date d\'entrée', //MOD-003++  //MOD-004++
    'sectiond98ec81bd9ff2a88d6da#formulaire.INTERVENTIONS_EN_COURS$MOTCLE|FR_Hiring confirmation;Confirmation d\'embauche',
    'section4bd2d74550485a7ff8e7#formulaire.INTERVENTIONS_EN_COURS$MOTCLE|FR_Career Change;Données carrière;FR_Contract;Contrat',
    'sectione18525e831548e8916d4#formulaire.INTERVENTIONS_EN_COURS$MOTCLE|FR_Career Change;Données carrière;FR_Contract;Contrat',
    'section409447a2b7ee325204f0#formulaire.INTERVENTIONS_EN_COURS$MOTCLE|FR_Career Change;Données carrière;FR_Contract;Contrat',
    'sectiondd3bb74df186ec5a5a77#formulaire.INTERVENTIONS_EN_COURS$MOTCLE|FR_Probation period;Période d\'essai;FR_Contract;Contrat;FR_Hiring confirmation;Confirmation d\'embauche;FR_Start Date Change;Décalage date d\'entrée',
...
window.checkField = function () {
    ...
    this.setTimeout(function(){
        if ($('#MOTSCLES').val() == "2365") {
            console.log('adfgdyhfghfh');
            $('#section8a946d74df34143b2a03').show();
